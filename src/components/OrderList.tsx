...
export function OrderList() {
    ...
    return (
        <div id="order_list" className="flex flex-row">
                                    ...
                                    <tr>
                                        ...
                                        <td className="border border-slate-300 font-light">
                                            <div className="flex flex-row justify-evenly items-center">
                                                <button onClick={() => dispatch(stateModal({ show: true, openModal: "DETAIL" }))} className="text-[blue] hover:text-blue-500 hover:bg-gray-100">ดูรายละเอียด</button>
                                                <button onClick={() => dispatch(stateModal({ show: true, openModal: "DELETE" }))} className="text-xs text-red-600 hover:text-red-400 font-bold p-2 rounded shadow mx-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4">
            ...
            {modal.openModal === "DETAIL" ? <ModalDetail /> : modal.openModal === "DELETE" ? <ModalDelete /> : null}
        </div>
    )
}